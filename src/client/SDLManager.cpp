...
void SDLManager::render_waiting_screen(int players_connected, int players_required,
    ...
    int large_font_size = 20;
    int small_font_size = 10;

    SDL2pp::SDLTTF ttf;
    SDL2pp::Font largeFont("../assets/gfx/fonts/sourcesans.ttf", large_font_size);
    SDL2pp::Font smallFont("../assets/gfx/fonts/sourcesans.ttf", small_font_size);
